...
createContainer(){
   ...
   docker create --name bbox_mongo --net host --env-file $parentBasePath/docker.conf -v /etc/localtime:/etc/localtime:ro -v ${DATA_PATH}/mongo:/home/mongo  bbox_mongo:prod
   sleep 2
